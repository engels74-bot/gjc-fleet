...
Modular architecture documentation for the autonomous GitHub repo-bot system on this host.
...
| repo-bot | issue → run → review → merge-gate glue | `~/github/engels74-bot/gjc-bot-scripts` | `~/.repo-bot` | systemd path/timers + hermes cron |

```
GitHub ──poll── clawhip ──spool──▶ repo-bot ──runs──▶ gjc / claude ──PRs──▶ GitHub
                   │                                                        │
